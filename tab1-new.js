var LEVEL, HOBBY, CLIENT_ALT_GOAL, BUDGET, SELECTBOX_2, CELECTBOX, last;
...
var we_tabs_next_button = '[bloc=next-tab]';
    ...
    SELECTBOX_2 = getValueFromInput("SELECTBOX_2");
      ...
      $(we_tabs_next_button).addClass(we_tabs_active_class);
      $(".w--tab-active").attr('next-tab',nextTab);
      $($('[data-w-tab=CELECTBOX]')).attr('prev-tab',we_activeTab);
    ...
    $("[name=CELECTBOX]").on("input", function () {
    CELECTBOX = getValueFromInput("CELECTBOX");
    ...
    $("[name=CELECTBOX]").parent("label.w-radio").on("click", function () {
      clickedRadioButtonValue = $("input", this).val();
      CELECTBOX = getValueFromInput("CELECTBOX");
